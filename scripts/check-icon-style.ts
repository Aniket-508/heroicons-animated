...
const REQUIRED_PATTERNS = [
  ...
  { pattern: /from\s+["']motion\/react["']/, message: 'Missing motion/react import' },
  ...
  { pattern: /useImperativeHandle/, message: 'Missing useImperativeHandle import' },
  { pattern: /useRef/, message: 'Missing useRef import' },
  { pattern: /export\s+interface\s+\w+IconHandle/, message: 'Missing IconHandle interface' },
  { pattern: /interface\s+\w+IconProps/, message: 'Missing IconProps interface' },
  { pattern: /const\s+\w+Icon\s*=/, message: 'Missing Icon component definition' },
  { pattern: /forwardRef/, message: 'Missing forwardRef usage' },
  { pattern: /useImperativeHandle/, message: 'Missing useImperativeHandle usage' },
